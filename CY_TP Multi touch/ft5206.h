...
#ifndef		DEF_X_MAX_POS
#define		DEF_X_MAX_POS			(800)
#endif
	
#ifndef		DEF_Y_MAX_POS
#define		DEF_Y_MAX_POS			(480)
#endif
	
#ifndef		DEF_X_MIRROR
#define		DEF_X_MIRROR			(0)
#endif
	
#ifndef		DEF_Y_MIRROR
#define		DEF_Y_MIRROR			(0)
#endif

#ifndef		DEF_XY_SWAP
#define		DEF_XY_SWAP				(1)
#endif
...
sbit 		FT5206_RST_PIN	=  		P3^2;
sbit		FT5206_INT_PIN	= 		P1^6;
//sbit		FT5206_SCL		=		P1^4;
//sbit		FT5206_SDA		=		P1^5;
	
//I2C读写命令
#define DEF_TP_DEV_ADDR 			0X24    	/* ADDRESS */
#define FT_CMD_WR 					0X48    	/* 写命令 */
#define FT_CMD_RD 					0X49		/* 读命令 */
   
#define	INPUT_REPORT_ADDR			(0X0003)
...
extern _FT5206_Info idata FT5206_Info;
